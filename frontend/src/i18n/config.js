  ...
  vi: {
    translation: {
      ...
      booking: {
        ...
        detail: 'Xem chi tiết',
        seeAllOptions: 'Xem tất cả lựa chọn',
        favoriteRoom: 'Yêu thích phòng',
      ...
      admin: {
        ...
        dashboard: 'Dashboard',
        rooms: 'Quản lý phòng',
        roomInventory: 'Quản lý tồn kho phòng',
        roomTypes: 'Loại phòng',
        availableStock: 'Tồn kho còn lại',
