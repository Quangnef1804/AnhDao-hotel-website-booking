  ...
  vi: {
    translation: {
      ...
      auth: {
        ...
        avatarHint: 'Kéo ảnh để căn giữa và dùng thanh trượt để phóng to hoặc thu nhỏ.',
  ...
  en: {
    translation: {
      ...
      auth: {
        ...
        avatarHint: 'Drag the image to position it and use the slider to zoom in or out.',
        zoom: 'Zoom',
        loginTitle: 'Login',
